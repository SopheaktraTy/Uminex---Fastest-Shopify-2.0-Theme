  ...
  c(document).on("click", ".product a.compare:not(.added)", function (o) {
    ...
    "undefined" != typeof c.fn.block &&
      ...
      c.ajax({
        ...
        dataType: "json",
        success: function (o) {
          "undefined" != typeof c.fn.block && (e.unblock(), t.unblock()),
            e
              .addClass("added")
              .attr("href", o.table_url)
              .text(yith_woocompare.added_label),
            t.html(o.widget_table),
            "yes" == yith_woocompare.auto_open &&
              c("body").trigger("yith_woocompare_open_popup", {
    ...
    c("body").on("yith_woocompare_open_popup", function (o, e) {
      ...
      if (768 <= c(window).width())
          ...
          onClosed: function () {
            ...
            "undefined" != typeof c.fn.block &&
              ...
              c.ajax({
                ...
                data: o,
                success: function (o) {
                  "undefined" != typeof c.fn.block && e.unblock().html(o),
                    e.html(o);
                },
              });
          },
        ...
        if (2 <= t.length) {
          for (
            var a = encodeURIComponent("iframe") + "=",
              r = t[1].split(/[&;]/g),
              n = r.length;
            0 < n--;
      ...
      "undefined" != typeof c.fn.block &&
        ...
        c.ajax({
          ...
          success: function (o) {
            ...
            c("#yith-woocompare").replaceWith(o),
              c(
                '.compare[data-product_id="' + e.data("product_id") + '"]',
                window.parent.document
              )
                .removeClass("added")
                .html(yith_woocompare.button_text),
              c(document).trigger("yith_woocompare_product_removed");
          },
        });
    }),
    c(".yith-woocompare-open a, a.yith-woocompare-open").on(
      "click",
      function (o) {
        o.preventDefault(),
          c("body").trigger("yith_woocompare_open_popup", {
            response:
              (function (o, e) {
                ...
                var t = document.location.search,
                  ...
                  o = new RegExp("(&|\\?)" + o + "=[^&]*");
                (t = t.replace(o, "$1" + e)),
                  RegExp.$1 || (t += (0 < t.length ? "&" : "?") + e);
                return t;
              })("action", yith_woocompare.actionview) + "&iframe=true",
          });
      }
    ),
    c(".yith-woocompare-widget")
          ...
          c.ajax({
            ...
            success: function (o) {
              c(
                "all" == t
                  ? ".compare.added"
                  : '.compare[data-product_id="' + t + '"]'
              )
                .removeClass("added")
                .html(yith_woocompare.button_text),
                a.html(o),
                "undefined" != typeof c.fn.block && a.unblock();
            },
          });
      }),
